...
def save_results(num_vertices, edge_range, runs, prim_time, kruskal_time):
    with open("mst_results.txt", "a") as f:
        f.write(f"Run Parameters: Vertices={num_vertices}, Edge Range={edge_range}, Runs={runs}\n")
...
def main():
    ...
    prim_times, kruskal_times, edges = benchmark_mst(num_vertices, edge_range, runs)
    ...
    save_results(num_vertices, edge_range, runs, avg_prim_time, avg_kruskal_time)
